...
type MachineRolesApi struct {
	Configuration *Configuration
}

func NewMachineRolesApi() *MachineRolesApi {
	configuration := NewConfiguration()
	return &MachineRolesApi{
		Configuration: configuration,
	}
}

func NewMachineRolesApiWithBasePath(basePath string) *MachineRolesApi {
	configuration := NewConfiguration()
 ...
 * @return []string
 */
func (a MachineRolesApi) ApiMachinerolesAllGet() ([]string, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/api/machineroles/all"
	...
	var localVarAPIResponse = &APIResponse{Operation: "ApiMachinerolesAllGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
