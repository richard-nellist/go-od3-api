...
func NewProgressionApi() *ProgressionApi {
...
func NewProgressionApiWithBasePath(basePath string) *ProgressionApi {
	configuration := NewConfiguration()
 ...
 */
func (a ProgressionApi) ApiProgressionIdGet(id string) (*ProgressionResource, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/api/progression/{id}"
	...
	var successPayload = new(ProgressionResource)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ApiProgressionIdGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
