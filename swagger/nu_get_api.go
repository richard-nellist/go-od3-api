...
func NewNuGetApiWithBasePath(basePath string) *NuGetApi {
	configuration := NewConfiguration()
 ...
 * @return void
 */
func (a NuGetApi) NugetPackagesPut() (*APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/nuget/packages"
	...
	var localVarAPIResponse = &APIResponse{Operation: "NugetPackagesPut", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
