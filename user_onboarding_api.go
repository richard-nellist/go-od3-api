...
type UserOnboardingApi struct {
	Configuration *Configuration
}

func NewUserOnboardingApi() *UserOnboardingApi {
	configuration := NewConfiguration()
	return &UserOnboardingApi{
		Configuration: configuration,
	}
}

func NewUserOnboardingApiWithBasePath(basePath string) *UserOnboardingApi {
	configuration := NewConfiguration()
 ...
 * @return void
 */
func (a UserOnboardingApi) ApiUseronboardingGet() (*APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/api/useronboarding"
	...
	var localVarAPIResponse = &APIResponse{Operation: "ApiUseronboardingGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
