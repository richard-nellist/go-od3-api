...
type UserRoleResource struct {
	...
	SupportedRestrictions []string `json:"SupportedRestrictions,omitempty"`

	PermissionDescriptions []string `json:"PermissionDescriptions,omitempty"`

	GrantedPermissions []int32 `json:"GrantedPermissions,omitempty"`
